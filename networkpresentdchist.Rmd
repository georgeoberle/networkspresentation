...
```{r}
V(netsoc)$shape <- ifelse(netsoc_df$Location, "square", "circle")
V(netsoc)$color <- ifelse(netsoc_df$Location, "red", "lightblue")
plot(netsoc_df)
...
```{r}
V(members_col)$shape <- ifelse(members_col$Location, "square", "circle")
V(members_col)$color <- ifelse(members_col$Location, "red", "lightblue")
plot(members_col)
```
...
V(netsoc_df)$shape <- ifelse(netsoc_df$Washington, "square", "circle")


V(netsoc_df)$color <- ifelse(netsoc_df$Location, "red", "lightblue")
plot(netsoc_df)
