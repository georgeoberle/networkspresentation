...
title("APS, AAAS, ANS", sub = "A bipartite layout of members and organizations",cex.main = 2,   font.main= 4, col.main= "black", cex.sub = 0.75, font.sub = 3, col.sub = "black")
```
full_members
